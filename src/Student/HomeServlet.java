 ...
 */
@WebServlet(urlPatterns = {"/home", "/Home", "/trangchu"})
...
//            int pageSize= Integer.parseInt(b);
//            int count = pageSize*(page-1);
//            request.setAttribute("DataTotal",Student.Pagination(pageSize,page));
        	String c="";
        	request.setAttribute("DataClass",ClassR.List(c));
            request.setAttribute("DataTable",Student.List(s));
            request.setAttribute("web_title","Student List");
