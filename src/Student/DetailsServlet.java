 ...
 */
@WebServlet(urlPatterns = {"/details", "/chitiet"})
public class DetailsServlet extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        try {
            ...
            request.setAttribute("Data",Student.Details(StudentId));
            request.setAttribute("web_title","Details Student");
            request.setAttribute("web_content","details.jsp");
