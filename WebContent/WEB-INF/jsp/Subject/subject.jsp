	...
	<div class="col-auto">
		<div class="page-utilities">
			<div
				...
				<!--//col-->
				<div class="col-auto">
					<a class="btn btn-secondary" href="/addSubject" role="button"><i
						...
						<tbody>
							<c:forEach var="Data" items="${requestScope.DataTable}">
								<tr>
									...
									<td class="cell">${Data.NameSubject}</td>
									<td class="cell"><a class="btn-sm app-btn-secondary"
										href="/editSubject?SubjectId=${Data.SubjectId}">Edit</a> <a
										class="btn-sm app-btn-secondary"
										href="/deleteSubject?SubjectId=${Data.SubjectId}">Delete</a> <a
										class="btn-sm app-btn-secondary"
										href="/detailsSubject?SubjectId=${Data.SubjectId}">View</a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
					<a type="reset" href="subject" class="btn btn-reset border form-control text-success">Reset</a>
				</div>
				<!--//table-responsive-->
